...
def getInitialData():
    ...
    global t1_data
    t1_data = execute_query("""SELECT A01_Name, A01_X, A01_Y, A02_Name, A02_X, A02_Y, A03_Name, A03_X, A03_Y,A04_Name, A04_X, A04_Y, A05_Name, A05_X, A05_Y, A06_Name, A06_X, A06_Y, A07_Name, A07_X, A07_Y, A08_Name, A08_X, A08_Y, A09_Name, A09_X, A09_Y, A10_Name, A10_X, A10_Y,A11_Name, A11_X, A11_Y, possession FROM mancityVbayern WHERE half = 0   """ )
